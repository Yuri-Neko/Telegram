...
exports.start = async(lol, name) => {
    text = `[ SHIORI BOT TELEGRAM]
    
Hello ${name}!
User : ${name}! 
Nama Bot : Hiraiki Shiori 
Language : JavaScript
Engine : Node Js
Owner : [CharOwner](https://t.me/KeyargaSama)
Type : /help`
    ...
    options = {
        reply_markup: {
            inline_keyboard: [
                ...
                [
                    { text: 'Random Cewe (ApikeyAbis) ', callback_data: 'awewe-' + user_id },
                ],
                [
                    { text: 'Downloader ⬇️ (ApikeyAbis) ', callback_data: 'donglod-' + user_id },
                    { text: 'Text Pro 📸 (ApikeyAbis) ', callback_data: 'textpro-' + user_id },
                 ],
                 [
                    { text: 'Random Text 💬(ApikeyAbis) ', callback_data: 'random-' + user_id },
                    { text: 'Nsfw ⚠️(ApikeyAbis) ', callback_data: 'nsfw-' + user_id },
                ],
            ]
        }
    }
...
exports.inpo = async(lol, user_id) => {
    prefix = config.prefix
    text = `       𝗜𝗡𝗙𝗢 𝗕𝗢𝗧 Shiroi


𝗡𝗮𝗺𝗮 𝗕𝗼𝘁 : Hiraiki Shiroi
𝗢𝘄𝗻𝗲𝗿 : @KeyargaSama
𝗟𝗮𝗻𝗴𝘂𝗮𝗴𝗲 : 𝗝𝗮𝘃𝗮𝗦𝗰𝗿𝗶𝗽𝘁
𝗘𝗻𝗴𝗶𝗻𝗲 : 𝗡𝗼𝗱𝗲 𝗝𝘀
